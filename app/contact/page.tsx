...
export const metadata: Metadata = {
  ...
  description: "Get in touch with AG Creative for growth marketing and creative partnerships."
};
  ...
  return (
    <section className="container-section py-12 md:py-16">
      <div className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-8 md:p-10">
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-tight text-white">Let’s build your next growth story.</h1>
        <p className="mt-4 text-white/75">
          Replace this section with your preferred contact method (form embed, calendar link, or CRM integration).
          For now, email AG Creative directly.
        </p>
